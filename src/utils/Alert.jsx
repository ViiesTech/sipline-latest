...
export const NoResultFound = () => {
  return (
    <View
      ...
      <Image
        source={{uri: 'https://i.imghippo.com/files/wNG9J1729034425.jpg'}}
...
export async function getCardType(cardNumber) {
  ...
  const creditCardRegex =
    /^(?:4[0-9]{12}(?:[0-9]{3})?|[25][1-7][0-9]{14}|6(?:011|5[0-9]{2})[0-9]{12}|3[47][0-9]{13}|3(?:0[0-5]|[68][0-9])[0-9]{11}|(?:2131|1800|35\d{3})\d{11})$/;
  const debitCardRegex =
    /^(?:5018|5020|5038|6304|6759|6761|6762|6763|0604|6390)\d{8,15}$/;
