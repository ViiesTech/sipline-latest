...
export const endPoints = {
    ...
    forgetPassword: '/api/customer/auth/forget_password',
    otpVerification: '/api/customer/auth/otp_verification',
    resetPassword: '/api/customer/auth/reset_password',
    signIn: '/api/customer/auth/signin',
