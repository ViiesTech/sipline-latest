    ...
    return (
        <>
            <AuthLayout navigation={navigation}>
                <Wrapper>
                    <Br space={3} />
                    <H4 bold style={{ textAlign: 'center' }}>Reset Password</H4>
                    <Pera style={{ textAlign: 'center' }}>Please enter your new password to reset password</Pera>
                    <Br space={3} />

                    <Pera style={{ marginBottom: hp('0.5%'), paddingLeft: wp('1%') }}>New Password</Pera>
                    <Input
                        leftIcon={
                            <Unlock
                                size={hp('3%')}
            ...
            <Btn
                ...
                onPress={resetUserPassword} style={{ position: 'absolute', zIndex: 1, bottom: hp('3%'), width: wp('88%'), alignSelf: 'center' }}>
                Reset
            </Btn>
        </>
    );
