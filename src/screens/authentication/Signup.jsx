...
const Signup = ({navigation}) => {
  ...
  const isValid = () => {
    ...
    if (!agreeToTerms) {
      Message(
        'Kindly Accept Our terms!',
        'you need to agree our terms of use and privacy policy.',
      );
      return false;
    }
    return true;
  ...
  return (
    <AuthLayout navigation={navigation}>
      <Wrapper>
        ...
        <Input
          leftIcon={<Call size={hp('3%')} color={Color('inputIcons')} />}
          styling={{marginBottom: hp('2%')}}
        ...
        <Br space={3} />
        <Btn loading={loading} onPress={SignUp}>
          Signup
        </Btn>
