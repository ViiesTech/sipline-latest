    ...
    return (
        <Background>
            <Wrapper>
                ...
                <Br space={4} />
                <H3 style={{ textAlign: 'center' }} bold>Edit Profile</H3>
                <Br space={3} />
                <ProfileImage
                    onpress={() => {
                        Message(
                    ...
                    imgUrl={profile?.profile_imageUrl || `${baseUrl}/customer/images/${userData?.profile_image}`} />
                <Br space={3} />
                <Pera style={{ marginBottom: hp('0.5%'), paddingLeft: wp('1%') }}>Full Name</Pera>
                <Input
                    leftIcon={
                        <User size={hp('3%')} color={Color('inputIcons')} variant="Outline" />
                ...
                <Br space={1.5} />
                <Pera style={{ marginBottom: hp('0.5%'), paddingLeft: wp('1%') }}>Gender</Pera>

                <View style={{ flexDirection: 'row', gap: 20, justifyContent: 'center' }}>
                    <View>
                        <TouchableOpacity onPress={() => setProfile({ ...profile, gender: 'male' })} style={genderSelectBox}>
                    ...
                    <View>
                        <TouchableOpacity onPress={() => setProfile({ ...profile, gender: 'female' })} style={genderSelectBox}>
                ...
                <Br space={3} />
                <Btn loading={loader} onPress={updateProfile}>Update</Btn>
                <Br space={3} />
            </Wrapper>
        </Background>
    );
